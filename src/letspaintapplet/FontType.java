...
//	private JLabel label;
	...
	{
		String[] JButtonLabels={"arial", "times new roman", "comic sans ms", "sans serif", "calibri", "couriers", "cursive", "monospace", "verdana"};
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		else if(event.getActionCommand().equals("comic sans ms"))
		{
			...
			System.out.println("comic sans ms");
